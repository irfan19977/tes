<header class="main-header navbar">
        ...
        <div class="col-nav">
          ...
          <ul class="nav">
            ...
            @auth
            <li class="dropdown nav-item"><a class="dropdown-toggle" id="dropdownAccount" data-bs-toggle="dropdown" href="#" aria-expanded="false"><img class="img-xs rounded-circle" src="assets/imgs/people/avatar2.jpg" alt="User"><span class="ms-2 d-none d-sm-inline">{{ auth()->user()->name ?? auth()->user()->email }}</span></a>
              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownAccount">
                <span class="dropdown-item-text"><strong>{{ auth()->user()->name ?? auth()->user()->email }}</strong></span>
